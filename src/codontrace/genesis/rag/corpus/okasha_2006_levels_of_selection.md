...
- **id:** `okasha_2006_levels_of_selection`
- **authors:** Samir Okasha
- **year:** 2006
- **venue:** Oxford University Press
- **identifiers:** doi:10.1093/acprof:oso/9780199267972.001.0001
- **tags:** Okasha, MLS1, MLS2, multilevel selection, Price equation, levels of selection, 2006, collective intelligence, evidence
...
- MLS1 fitness accounting is not the same as MLS2 evolutionary outcome.
- A group-vs-individual delta can be bookkeeping; the question is which strategy wins.
- Multilevel selection is an experiment, not a rank table.
