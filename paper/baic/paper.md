...
کلیدواژه: اعتبارسنجی in silico، حسابرسی شواهد، مدل‌سازی محاسباتی، نردبان اعتبار
...
آویدا بستر برنامه‌های خودتکثیرشونده است [11] و پروندهٔ `.dat` آن از همین در خوانده می‌شود. پایداری عملکرد در محیط نامطمئن [12] با بازپخش بیت‌به‌بیت یکی نیست. MIRROR بستهٔ شواهد محلی و نتیجهٔ بازپخش را پیش از انتشار قابل‌بازبینی می‌کند و حقیقت یا تضمین تنظیم‌گری نمی‌دهد [19]. NovaFabric اجرای عامل را در کپسول امضاشده ثبت می‌کند و سقف ادعا نمی‌گذارد [20]. تفاوت این کار درجه است: حسابرس بالاترین سطحی را برمی‌گرداند که شرط‌های همان بسته برقرار باشد. توصیف مدل از پروتکل ODD است [13]. رشتهٔ `asme_vv40_passed` در پیکربندی پذیرفته نمی‌شود، چون این ابزار گواهی استاندارد صادر نمی‌کند.
...
[19] A. Sokolov, “MIRROR: Local Evidence Bundles for Reproducible Research Software Review,” Zenodo, May 2026, doi: 10.5281/zenodo.20463358.

[20] M. Seyedkazemi Ardebili, “NovaFabric: Tamper-Evident, Replayable Evidence for Autonomous AI Agent Runs,” arXiv:2609.12582, 2026.
