...
_STABLE_SYMBOLS: tuple[tuple[str, str, str, bool], ...] = (
    ...
    ("HardExperiment01Campaign", "codontrace.genesis", "0.3.0b4.dev0-hard-experiment-01", False),
    ("run_hard_experiment_01", "codontrace.genesis", "0.3.0b4.dev0-hard-experiment-01", False),
    ("HardExperiment01DoseResponse", "codontrace.genesis", "0.3.0b4.dev0-hard-experiment-01-wave1", False),
    ("run_hard_experiment_01_dose_response", "codontrace.genesis", "0.3.0b4.dev0-hard-experiment-01-wave1", False),
    ("hard_experiment_01_dag", "codontrace.genesis", "0.3.0b4.dev0-hard-experiment-01-wave1", False),
