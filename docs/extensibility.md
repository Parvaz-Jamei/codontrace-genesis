...
CodonTrace Genesis now provides configurable GENESIS research primitives through explicit Registry, Config, Spec, and Protocol objects.
...
This does not make CodonTrace Genesis an app, plugin framework, or configuration-file framework. Core APIs accept Python objects and remain dependency-free.
