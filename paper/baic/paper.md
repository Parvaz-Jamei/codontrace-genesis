...
جدول ۲ کنترل منفی بخش ارزیابی است و عمداً بدون شاهد اجرایی ساخته شده است. سطح خروجی آن صفر است.
