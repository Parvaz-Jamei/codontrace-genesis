...
8. Scientific authorities 2026 map (`docs/SCIENTIFIC_AUTHORITIES_2026.md`): literature matrix vs Avida / MODES / Channon 2024 / JaxLife / Aevol / OntoAvida / ASAL / BMC Evol Biol 2021. Completeness of *measurement and documentation*, not a claim that CodonTrace replaces those systems. JaxLife NN and ASAL CLIP stay docs-only.
