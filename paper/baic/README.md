...
- English IEEE-style manuscript, same measurements: [`BAIC2026_Jamei_en.docx`](BAIC2026_Jamei_en.docx). Rebuild with `python tools/build_baic_ieee_docx.py`. [`ieee_template.docx`](ieee_template.docx) is the conference style source, not the paper.
