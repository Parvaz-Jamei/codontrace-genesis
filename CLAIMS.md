...
| Life-loop ecology preset | `GenesisRuntimeProfile.life_loop_world()` can run a short eat → survive → asexual reproduce loop with food, optional respawn, adjacent placement, and ATP/AliveGate reproduction gates. | Allowed as software capability / runtime observation. Do not claim proof of life, intelligence, cooperation, or instinct evolution. |
