...
| [`docs/PHASE_K_CI_DEPTH.md`](docs/PHASE_K_CI_DEPTH.md) | Phase K: evolved coordination instructions, Goldsby-scale CPU-delay harness, Price transmission, Michod/Conlin hooks; ClaimGate honest |
| [`docs/PHASE_L_AVIDA_FIDELITY.md`](docs/PHASE_L_AVIDA_FIDELITY.md) | Phase L: closer Avida ORGANISM_MESSAGING / DEME_GROUP analogs, Goldsby-aligned specialist measurement, optional Phase K ablation evidence feed; ClaimGate honest |
