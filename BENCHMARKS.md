...
The runner is the user-facing benchmark entry point. It produces CSV/JSON/HTML artifacts and is designed to stay compatible with the public-beta `0.3.0b3` branch.
...
| CodonTrace Genesis version | `0.3.0b3` |
| Target public version | `0.3.0b3` |
| Expected version | `0.3.0b3` |
| Release DOI | `10.5281/zenodo.20337435` |
| Profile | `smoke` |
| Seed start | `1` |
| Seed count | `1` |
...
For the `0.3.0b3` beta release, benchmark provenance should report a single aligned release identity:

```text
release_artifact_name: codontrace-0.3.0b3-release-bundle.zip
codontrace_version: 0.3.0b3
target_public_version: 0.3.0b3
expected_version: 0.3.0b3
```
