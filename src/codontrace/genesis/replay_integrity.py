...
_CI_PUBLIC_DIGEST_FIELDS: dict[str, tuple[str, ...]] = {
    'codontrace.contracts.life_loop_events.AblationArmEvent': ('digest',),
    'codontrace.contracts.life_loop_events.AttachmentEvent': ('digest',),
    'codontrace.contracts.life_loop_events.BirthAttachEvent': ('digest',),
    'codontrace.contracts.life_loop_events.ContactEvent': ('digest',),
    'codontrace.contracts.life_loop_events.EnergyCouplingEvent': ('digest',),
    'codontrace.contracts.life_loop_events.LifeLoopEventEnvelope': ('parent_digest', 'digest'),
    'codontrace.contracts.life_loop_events.PopulationRegistryEvent': ('digest',),
    'codontrace.contracts.life_loop_events.ScheduleLockEvent': ('digest',),
    'codontrace.genesis.host_parasite_analytics.ContinuumCellResult': ('meter_digest', 'world_digest', 'cell_digest'),
    'codontrace.genesis.host_parasite_analytics.ContinuumFactorialResult': ('digest',),
    'codontrace.genesis.host_parasite_analytics.DidCellResult': ('meter_digest', 'world_digest', 'cell_digest'),
    'codontrace.genesis.host_parasite_analytics.DidInterventionContrast': ('digest',),
    'codontrace.genesis.host_parasite_analytics.FrontDoorCellResult': ('meter_digest', 'world_digest', 'cell_digest'),
    'codontrace.genesis.host_parasite_analytics.FrontDoorMediationContrast': ('digest',),
    'codontrace.genesis.host_parasite_analytics.InterventionArmResult': ('meter_digest', 'world_digest', 'arm_digest'),
    'codontrace.genesis.host_parasite_analytics.InterventionContrastResult': ('digest',),
    'codontrace.genesis.host_parasite_analytics.ReciprocalObservationalContrast': ('digest',),
    'codontrace.genesis.host_parasite_calibration.CalibrationOutcome': ('observed_digest', 'target_digest', 'digest'),
    'codontrace.genesis.host_parasite_calibration.CalibrationReport': ('digest',),
    'codontrace.genesis.host_parasite_calibration.CalibrationTarget': ('digest',),
    'codontrace.genesis.host_parasite_metrics.HostParasiteMetricSummary': ('meter_digest', 'prereg_digest', 'digest'),
    'codontrace.genesis.host_parasite_metrics.HostParasitePreregSpec': ('digest',),
    'codontrace.genesis.host_parasite_metrics.SeedPlanSpec': ('digest',),
    'codontrace.genesis.host_parasite_world.HostParasiteProfile': ('digest',),
    'codontrace.genesis.host_parasite_world.LockedDigestAdapterRecord': ('locked_digest', 'adapter_digest'),
    'codontrace.life_loop.ablation_template.AblationApplyRecord': ('before_digest', 'after_digest', 'digest'),
    'codontrace.life_loop.ablation_template.AblationAttemptCensus': ('digest',),
    'codontrace.life_loop.ablation_template.AblationTemplate': ('digest',),
    'codontrace.life_loop.allele_association.AlleleAssociationResult': ('digest',),
    'codontrace.life_loop.allele_association.AlleleAssociationScore': ('digest',),
    'codontrace.life_loop.attachment.AttachmentBook': ('digest',),
    'codontrace.life_loop.attachment.AttachmentSlot': ('digest',),
    'codontrace.life_loop.conformal_bands.ConformalBandResult': ('digest',),
    'codontrace.life_loop.contact.ContactAttemptCensus': ('digest',),
    'codontrace.life_loop.contact.ContactTransferPolicy': ('digest',),
    'codontrace.life_loop.energy_coupling.EnergyCoupling': ('digest',),
    'codontrace.life_loop.energy_coupling.EnergyTransferLedgerEntry': ('digest',),
    'codontrace.life_loop.ess_invasion.EssInvasionResult': ('digest',),
    'codontrace.life_loop.ess_invasion.InvasionScore': ('digest',),
    'codontrace.life_loop.farm_orchestrator.FarmApplyRecord': ('ablation_record_digest', 'schedule_record_digest', 'state_digest', 'digest'),
    'codontrace.life_loop.farm_orchestrator.FarmPlan': ('digest',),
    'codontrace.life_loop.hook_meters.HookMeterSnapshot': ('digest',),
    'codontrace.life_loop.info_geometry.InfoGeometryContrast': ('digest',),
    'codontrace.life_loop.inherit_attached.InheritAttachedPolicy': ('digest',),
    'codontrace.life_loop.inherit_attached.InheritAttemptCensus': ('digest',),
    'codontrace.life_loop.mapper_cover.MapperCoverSnapshot': ('digest',),
    'codontrace.life_loop.match_rules.MatchRuleSpec': ('digest',),
    'codontrace.life_loop.persistent_entropy.PersistentEntropySnapshot': ('digest',),
    'codontrace.life_loop.phenotype.PhenotypeMap': ('digest',),
    'codontrace.life_loop.phenotype.PhenotypeRecord': ('digest',),
    'codontrace.life_loop.populations.PopulationRecord': ('digest',),
    'codontrace.life_loop.populations.PopulationRegistry': ('digest',),
    'codontrace.life_loop.schedule_lock.ScheduleLock': ('digest',),
    'codontrace.life_loop.schedule_lock.ScheduleLockApplyRecord': ('state_digest', 'digest'),
    'codontrace.life_loop.schedule_lock.ScheduleLockAttemptCensus': ('digest',),
    'codontrace.life_loop.schedule_lock.ScheduleLockState': ('digest',),
    'codontrace.life_loop.skyline_proxy.SkylineSeries': ('digest',),
    'codontrace.life_loop.skyline_proxy.SkylineWindow': ('digest',),
    ...
    'codontrace.life_loop.transfer_entropy.TransferEntropyResult': ('digest',),
}
for _path, _fields in _CI_PUBLIC_DIGEST_FIELDS.items():
    _DIGEST_FIELDS_BY_CLASS[_path] = _fields
NON_REPLAY_CRITICAL_DIGEST_CLASSES = tuple(
