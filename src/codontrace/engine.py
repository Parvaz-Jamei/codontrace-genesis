...
Replay-critical hashing lives in ``codontrace.engine_digest``. Tick / snapshot
/ run identity types live in ``codontrace.engine_results``. Both are re-exported
here so historical imports stay stable. See ``docs/ENGINE_REPLAY_CONTRACT.md``.
"""
