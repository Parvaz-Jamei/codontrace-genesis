...
Version source: `pyproject.toml` `[project].version` (currently `0.3.0b6`)
...
Package: `codontrace` (PyPI tip `0.3.0b6`; older `0.3.0b4` / `0.3.0b5` immutable)
Release identity on `main`: the pyproject version. `main` may be ahead of tag `v0.3.0b6`; that is not a recut.
