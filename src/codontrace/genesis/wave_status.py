...
def wave_status() -> dict[str, Any]:
    ...
    return {
        ...
        "next": "0.3.0b8 is tagged v0.3.0b8 and on PyPI; do not recut 0.3.0b4 / 0.3.0b5 / 0.3.0b6 / 0.3.0b7 / 0.3.0b8; HE03 research results_v1 stays absent on purpose; next public identity needs its own version",
    }
