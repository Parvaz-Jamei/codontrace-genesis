...
- a medical device, SaMD, IVD, FDA/CE clearance, or ASME V&V 40 certification.
  Biomedical labels are a ClaimGate `DomainProfile` port, not a second engine.
