# Comparator matrix — literature comparison ≠ identity

This port compares digital ClaimGate audit protocols against published
host–parasite / symbiont modeling literature. **Comparison is not identity.**
No row claims CRISPR genetics identity, phage-therapy clearance, vaccine
efficacy, epidemic certification, BSL rating, proved intelligence, proved Red
Queen dynamics, or a proved major transition.

| Comparator | Citation (see CITATIONS.md / evidence/) | What is compared | What is *not* claimed |
|---|---|---|---|
| Avida parasites / freeze–replay | Zaman et al. 2014 doi:10.1371/journal.pbio.1002023 | Three-arm freeze ≠ replay ≠ reciprocal digests; repertoire-richness analogue | Wet complexity emergence; Avida replacement; proved evolvability |
...
| ARD / FSD range labels | Hall et al. 2011; Lopez Pascua et al. 2014 | Digital ARD-like / FSD-like diagnostic enums; Phase 19 transition protocol | Proved Red Queen; wet infectivity/resistance proof |
...
| Lopez Pascua resource×FSD | doi:10.1111/ele.12337 | Resource/ATP × dynamics-label factorial (Phase 20 delivered) | Wet resource–virulence clinical claim |
...
column. Elevating a comparator to identity, clearance, or proved dynamics is
out of scope for CodonTrace Genesis host–parasite ClaimGate.
